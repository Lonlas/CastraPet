<?php
    class Usuario{
        ...
        function consultar()
        {
            ...
            $cmd = $con->prepare("SELECT idusuario, login.idlogin, nome, email, cpf, beneficio, nis, telefone, celular, usucep, usubairro, usurua, usunumero, punicao FROM usuario JOIN login on usuario.idlogin = login.idlogin");
