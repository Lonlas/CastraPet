                                ...
                                <div class="col-md">
                                    ...
                                    <div class="row text-center mb-3 aling-content-center">
                                        ...
                                        <div class="col-lg-6 justify-content-center aling-content-center">
                                            ...
                                            <input type="file" role="button" name="foto" id="inputImgAnimal" class="btn popover-test" accept="image/*" hidden>
                                            <label id="labelImgAnimal" for="inputImgAnimal" style="background-color: 0;">aaa</label>
                                            <img src="recursos/img/imagem_exemplo.jpg" alt="Foto do Animal" id="imgAnimal" for="inputImgAnimal" style="width:100%;">
                                        </div>
                                    </div>
                                </div>
                            </div>
